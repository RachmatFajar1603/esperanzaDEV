<x-app-layout>
    <x-slot name="header">
            {{ __('Up coming bookings') }}
    </x-slot>

    
<div class="relative overflow-x-auto shadow-md sm:rounded-lg bg-[]">
    <div class="flex items-center justify-between pb-4 bg-[]">
        <div class="">
            <button id="dropdownRadioButton" data-dropdown-toggle="dropdownRadio" class="inline-flex items-center text-gray-50 bg-[#12153D] border border-gray-300 focus:outline-none hover:bg-blue-950 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-3 py-1.5  " type="button">
            ...
            <!-- Dropdown menu -->
            <div id="dropdownRadio" class="z-10 hidden w-48 bg-[#12153D] divide-y divide-gray-100 rounded-lg shadow" data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="top" style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(522.5px, 3847.5px, 0px);">
                <ul class="p-3 space-y-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownRadioButton">
                    <li>
                        <div class="flex items-center p-2 rounded hover:bg-blue-950 ">
        ...
        <div class="relative">
            ...
            <input type="text" id="table-search" class="block p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-[#12153D] focus:ring-blue-500 focus:border-blue-500 " placeholder="Search for items">
        </div>
    </div>
    <table class="w-full text-sm text-left text-gray-500 bg-gray-50">
        <thead class="text-xs text-gray-100 uppercase bg-[#12153D]">
            <tr>
